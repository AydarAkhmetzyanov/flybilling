CREATE SCHEMA [payway] AUTHORIZATION [dbo]

create table [payway].[ErrorLog] 
            (
...
INSERT INTO [payway].[ClientsPrivateData] 
...
create table [payway].[Notifications]
            (
                [ID] [bigint] IDENTITY(1,1) NOT NULL,
				[timestamp] [smalldatetime] DEFAULT GETUTCDATE(),
				[text_ru] [nvarchar](4000) NULL, 
...
create table [payway].[Withdrawals]
            (
                [ID] [bigint] IDENTITY(1,1) NOT NULL,
				[timestamp] [smalldatetime] DEFAULT GETUTCDATE(),
...
create table [payway].[SMSServices] 
            (
                [ID] [int] IDENTITY(1,1) NOT NULL,
                [country] [char](2) NULL, 
...
create table [payway].[SessionSMS]
            (
                [ID] [bigint] IDENTITY(1,1) NOT NULL,
				[timestamp] [smalldatetime] DEFAULT GETUTCDATE(),
...
create table [payway].[SessionServices] 
            (
                [ID] [int] IDENTITY(1,1) NOT NULL,
                [country] [char](2) NULL, 
...
create table [payway].[SMSCorePrefixes] 
            (
			    [ID] [int] IDENTITY(1,1) NOT NULL,
                [prefix] [nvarchar](255) NULL,
                [country] [char](2) NULL,
...
SET IDENTITY_INSERT [payway].[Countries] ON;

INSERT INTO [payway].[Countries] (ID, name, code, a1) VALUES
(1, N'Россия', 'ru', 1),
(2, N'Эстония', N'ee', 2),
(3, N'Украина', N'ua', 3),
...
SET IDENTITY_INSERT [payway].[Agregators] ON;

INSERT INTO [payway].[Agregators]  (ID, name) VALUES
(1,N'I-Free');

create table [payway].[Numbers] 
            (
                [ID] [int] IDENTITY(1,1) NOT NULL,
